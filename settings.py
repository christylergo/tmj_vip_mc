...
warehouses_key_re = ['汉川', '城东', '岭顶|领顶', '越中', '琳达', '批发|五夫', '昆山', '修正']
...
daily_sales_week_priority = [
    [FEATURE_PRIORITY['DAILY_SALES_WEEK'][0] + i, FEATURE_PRIORITY['DAILY_SALES_WEEK'][1]]
...
COLUMN_PROPERTY = [
    {'identity': 'row_nu', 'name': '序号', 'refer_doc': 'self', 'floating_title': placeholder},
    ...
    {'identity': 'site_DSI', 'name': '', 'refer_doc': 'self', 'floating_title': placeholder},
    {'identity': 'site_inventory', 'name': '页面库存余量', 'refer_doc': 'vip_routine_site_stock', 'floating_title': '可扣库存'},
    {'identity': 'disassemble', 'name': '组合分解', 'refer_doc': 'self', 'floating_title': placeholder},
...
DOC_REFERENCE = [
        ...
        },
    {
        ...
        'key_words': '常态商品运营', 'key_pos': ['条码', ], 'val_pos': ['尺码状态', ], 'val_type': ['str', ],
        'importance': 'caution'
        },
    {
        ...
        },
    {
        ...
        'val_pos': [
            '商家编码(替代1)', '商家编码(替代2)', '商家编码(替代3)', '商家编码(替代4)',
        ...
        },
    {
        ...
        'key_words': '唯品库存统计分析', 'key_pos': [], 'val_pos': [], 'val_type': [],
        'importance': 'optional'
        },
]
